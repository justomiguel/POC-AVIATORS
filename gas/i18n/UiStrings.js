...
var UI_STRINGS = {
  es: {
    ...
    page_proposal_building_lead_html:
      'Subí un RFP, transcript o notas y validá el brief extraído. Después elegí la industria para usar el <strong>deck base</strong> correcto y armá la propuesta con el agente de propuestas.',
    page_proposal_building_chat_lead:
      'Adjuntá material o describí el pedido del cliente. Al enviar se extrae y valida el brief antes de construir la propuesta.',
    pb_consult_heading: 'Brief y conversación',
    pb_consult_lead:
      'Podés adjuntar PDF, texto, Word o imagen. Al enviar (o pedir «validar brief») extraemos cliente, alcance, modelo comercial y fechas para que los confirmes.',
    chat_empty_hint_proposal_building:
      'Empezá describiendo el pedido o adjuntá un RFP. Al enviar validamos el brief antes de armar la propuesta.',
  ...
  en: {
    ...
    page_proposal_building_lead_html:
      'Upload an RFP, transcript or notes and validate the extracted brief. Then pick the industry to use the right <strong>base deck</strong> and build the proposal with the proposals agent.',
    page_proposal_building_chat_lead:
      'Attach material or describe the client request. On send we extract and validate the brief before building the proposal.',
    pb_consult_heading: 'Brief and conversation',
    pb_consult_lead:
      'You can attach PDF, text, Word or an image. On send (or when you ask to “validate brief”) we extract client, scope, commercial model and dates for you to confirm.',
    chat_empty_hint_proposal_building:
      'Start by describing the request or attach an RFP. On send we validate the brief before building the proposal.',
