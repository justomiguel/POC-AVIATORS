...
var UI_STRINGS = {
  es: {
    ...
    nav_group_proposals: 'Propuestas',
    nav_proposal_building: 'Armado de propuestas',
    nav_my_proposals: 'Mis propuestas',
    nav_agents: 'Agentes',
    ...
    page_my_proposals_title: 'Mis propuestas',
    page_my_proposals_lead:
      'Todas las propuestas que armaste quedan guardadas con el brief extraído, los materiales subidos y los enlaces al deck y al checklist en Drive.',
    my_proposals_loading: 'Cargando tus propuestas…',
    my_proposals_empty: 'Todavía no tenés propuestas guardadas. Empezá un armado nuevo para crear la primera.',
    my_proposals_empty_filtered: 'Ninguna propuesta coincide con los filtros seleccionados.',
    my_proposals_filter_status_label: 'Estado',
    my_proposals_filter_industry_label: 'Industria',
    my_proposals_filter_step_label: 'Paso del armado',
    my_proposals_filter_deliverables_label: 'Entregables',
    my_proposals_filter_deliverables_any: 'Con entregables',
    my_proposals_filter_deliverables_deck: 'Con deck armado',
    my_proposals_filter_deliverables_package: 'Con paquete',
    my_proposals_filter_deliverables_none: 'Sin entregables',
    my_proposals_filter_search_label: 'Buscar propuestas',
    my_proposals_filter_search_ph: 'Cliente, título o resumen…',
    my_proposals_filter_label: 'Estado',
    my_proposals_filter_all: 'Todas',
    my_proposals_filter_status_aria: 'Filtrar propuestas por estado',
    my_proposals_filter_clear: 'Quitar filtro',
    my_proposals_btn_start: 'Armar nueva propuesta',
    my_proposals_btn_new: 'Nueva propuesta',
    my_proposals_btn_view: 'Ver propuesta',
    my_proposals_busy_loading: 'Cargando propuesta…',
    my_proposals_err_load: 'No se pudo cargar la propuesta.',
    my_proposals_btn_delete: 'Eliminar',
    my_proposals_confirm_delete:
      '¿Eliminar esta propuesta del listado? Los archivos en Drive no se borran automáticamente.',
    my_proposals_busy_deleting: 'Eliminando propuesta…',
    my_proposals_deleted: 'Propuesta eliminada del listado.',
    my_proposals_err_delete: 'No se pudo eliminar la propuesta.',
    my_proposals_sec_list_heading: 'Historial de propuestas',
    my_proposals_sec_list_lead:
      'Cada tarjeta resume el cliente, el estado del armado y los accesos directos al deck y al checklist en Drive.',
    my_proposals_meta_deadline: 'Entrega RFP: {date}',
    my_proposals_meta_updated: 'Actualizada: {date}',
    my_proposals_client_unknown: 'Cliente sin nombre',
    my_proposals_untitled: 'Propuesta sin título',
    my_proposals_err_list: 'No se pudo cargar el listado de propuestas.',
    my_proposals_col_client: 'Cliente',
    my_proposals_col_proposal: 'Propuesta',
    my_proposals_col_industry: 'Industria',
    my_proposals_col_status: 'Estado',
    my_proposals_col_deadline: 'Entrega RFP',
    my_proposals_col_updated: 'Actualizada',
    my_proposals_col_links: 'Enlaces',
    my_proposals_col_actions: 'Acciones',
    my_proposals_sort_label: 'Ordenar por',
    my_proposals_sort_columns_aria: 'Ordenar propuestas por columna',
    my_proposals_sort_dir_asc: 'Ascendente',
    my_proposals_sort_dir_desc: 'Descendente',
    my_proposals_sort_dir_toggle: 'Cambiar dirección de orden',
    my_proposals_links_pending: 'Sin archivos aún',
    my_proposals_status_completed: 'Completada',
    my_proposals_status_failed: 'Con error',
    my_proposals_status_in_progress: 'En progreso',
    my_proposals_status_step: 'En progreso · {step}',
    my_proposals_step_materials: 'Materiales',
    my_proposals_step_brief: 'Brief',
    my_proposals_step_studios: 'Studios',
    my_proposals_step_success_cases: 'Casos de éxito',
    my_proposals_step_configure: 'Configurar',
    my_proposals_step_building: 'Deck',
    page_proposal_view_title: 'Detalle de propuesta',
    page_proposal_view_lead:
      'Explorá el resumen, brief, materiales, studios y entregables de esta propuesta en modo lectura.',
    pv_btn_back: 'Volver a mis propuestas',
    pv_busy_loading: 'Cargando propuesta…',
    pv_err_load: 'No se pudo cargar la propuesta.',
    pv_tab_summary: 'Resumen y brief',
    pv_tab_overview: 'Resumen',
    pv_tab_brief: 'Brief',
    pv_tab_materials: 'Materiales',
    pv_tab_studios: 'Studios',
    pv_tab_deliverables: 'Entregables',
    pv_tabbar_aria: 'Secciones de la propuesta',
    pv_summary_sec_heading: 'Resumen y brief',
    pv_summary_sec_lead:
      'Panorama de la propuesta, accesos rápidos y el brief validado extraído de los materiales.',
    pv_overview_sec_heading: 'Panorama general',
    pv_overview_sec_lead:
      'Estado del armado, métricas clave y accesos rápidos a los archivos generados en Drive.',
    pv_brief_sec_heading: 'Brief validado',
    pv_brief_sec_lead:
      'Detalle extraído y confirmado a partir de los materiales del cliente, organizado por sección.',
    pv_materials_sec_heading: 'Materiales de origen',
    pv_materials_sec_lead:
      'Documentos vinculados a esta propuesta. Podés subir archivos nuevos o agregar enlaces de Drive existentes.',
    pv_materials_add_heading: 'Agregar material',
    pv_materials_upload_lead: 'Subí PDF, Word, texto o imágenes al folder de la sesión.',
    pv_materials_btn_pick: 'Elegir archivos',
    pv_materials_drive_lead: 'Enlace de Google Drive',
    pv_materials_drive_ph: 'https://drive.google.com/file/d/…',
    pv_materials_btn_add_drive: 'Agregar enlace',
    pv_materials_busy_upload: 'Subiendo material…',
    pv_materials_busy_drive: 'Vinculando archivo de Drive…',
    pv_materials_added: 'Material agregado a la propuesta.',
    pv_materials_err_upload: 'No se pudo agregar el material.',
    pv_materials_err_drive_empty: 'Pegá un enlace o ID de archivo de Google Drive.',
    pv_materials_source_drive: 'Enlace Drive',
    err_proposal_material_drive: 'No se pudo acceder al archivo de Drive. Verificá el enlace y los permisos.',
    err_proposal_material_invalid: 'Material inválido o vacío.',
    pv_deliverables_hero_deck_title: 'Propuesta armada',
    pv_deliverables_hero_deck_lead: 'Presentación generada en el armado de esta propuesta.',
    pv_deliverables_hero_package_title: 'Paquete de entregables',
    pv_deliverables_hero_package_lead: 'Carpeta en Drive con deck, checklist y archivos del paquete.',
    pv_deliverables_btn_open_deck: 'Abrir propuesta armada',
    pv_deliverables_btn_open_package: 'Abrir paquete completo',
    pv_studios_priority_icon_high: 'Alta relevancia',
    pv_studios_priority_icon_medium: 'Relevancia media',
    pv_studios_priority_icon_low: 'Complementario',
    pv_studios_sec_heading: 'Studios recomendados',
    pv_studios_sec_lead: 'Studios sugeridos según el brief e industria, agrupados por relevancia.',
    pv_deliverables_sec_heading: 'Artefactos y deck',
    pv_deliverables_sec_lead:
      'Presentación armada, checklist, carpeta del paquete y opciones de contenido aplicadas.',
    pv_lbl_industry: 'Industria',
    pv_lbl_commercial_model: 'Modelo comercial',
    pv_lbl_rfp_deadline: 'Entrega RFP',
    pv_lbl_updated: 'Última actualización',
    pv_lbl_materials_count: 'Materiales',
    pv_lbl_studios_count: 'Studios',
    pv_lbl_scope_items: 'Ítems de alcance',
    pv_lbl_progress_step: 'Estado del armado',
    pv_lbl_constraints: 'Restricciones',
    pv_lbl_technology: 'Tecnología',
    pv_lbl_deck_sections: 'Secciones del deck',
    pv_agenda_module_title: 'Agenda',
    pv_agenda_module_lead: 'Orden de la presentación y secciones opcionales del deck.',
    pv_agenda_module_count_fmt: '{count} ítems',
    pv_agenda_modal_title: 'Agenda del deck',
    pv_agenda_modal_lead:
      'Secciones opcionales configuradas en el armado y orden final de la agenda de la presentación.',
    pv_agenda_list_heading: 'Orden de la agenda',
    pv_agenda_list_lead: 'Ítems que aparecen en la slide de agenda de la propuesta armada.',
    pv_btn_close_agenda: 'Cerrar',
    pv_lbl_success_cases: 'Casos de éxito aplicados',
    pv_deck_section_included: 'Incluida',
    pv_deck_section_excluded: 'Omitida',
    pv_overview_summary_heading: 'Resumen del proyecto',
    pv_quick_links_heading: 'Accesos rápidos',
    pv_materials_empty: 'No hay materiales registrados para esta propuesta.',
    pv_studios_empty: 'Todavía no hay studios recomendados.',
    pv_deliverables_empty: 'Todavía no se generaron entregables.',
    pv_brief_empty: 'Todavía no hay brief validado para esta propuesta.',
    pv_btn_open_case: 'Abrir caso',
    pv_btn_edit: 'Editar',
    pv_btn_save: 'Guardar',
    pv_btn_cancel: 'Cancelar',
    pv_btn_remove_row: 'Quitar fila',
    pv_busy_saving: 'Guardando cambios…',
    pv_btn_refresh_studios_all: 'Regenerar todos los studios',
    pv_btn_refresh_ai_pods_pitch: 'Regenerar pitch AI-PODs',
    pv_busy_refresh_studios_all: 'Regenerando studios (4 consultas en paralelo)…',
    pv_busy_refresh_studios_lane: 'Regenerando lane de studios…',
    pv_studios_refreshed: 'Studios actualizados.',
    pv_studios_lane_refreshed: 'Lane de studios actualizada.',
    pv_err_refresh_studios: 'No se pudieron regenerar los studios.',
    pv_err_refresh_studios_lane: 'No se pudo regenerar esa lane de studios.',
    pv_busy_refresh_ai_pods_pitch: 'Regenerando pitch AI-PODs con el agente de propuestas…',
    pv_ai_pods_pitch_refreshed: 'Pitch AI-PODs actualizado.',
    pv_err_refresh_ai_pods_pitch: 'No se pudo regenerar el pitch AI-PODs.',
    pv_saved: 'Propuesta actualizada.',
    pv_err_save: 'No se pudieron guardar los cambios.',
    pv_edit_brief_hint: 'Editá los campos del brief directamente en esta vista. Guardá para persistir los cambios.',
    pv_edit_mode_hint:
      'Modo edición: podés cambiar el estado, el paso del armado, el brief, materiales, studios y entregables. Guardá para persistir o cancelá para descartar.',
    pv_edit_lbl_internal_title: 'Título interno',
    pv_edit_lbl_material_name: 'Nombre del material',
    pv_edit_lbl_material_url: 'URL en Drive',
    pv_edit_btn_add_material: 'Agregar material',
    pv_edit_lbl_studio_name: 'Studio',
    pv_edit_lbl_studio_priority: 'Prioridad',
    pv_edit_lbl_studio_catalog: 'Título en catálogo',
    pv_edit_lbl_studio_offerings: 'Offerings (separados por coma)',
    pv_edit_lbl_studio_rationale: 'Fundamento',
    pv_edit_studio_pitch_preview_heading: 'Vista enriquecida (AI-PODs)',
    pv_edit_studio_rationale_plain_hint: 'Texto plano para edición manual (se guarda junto al JSON estructurado).',
    pv_edit_lbl_studio_url: 'URL en Drive',
    pv_edit_btn_add_studio: 'Agregar studio',
    pv_edit_deliverables_hint: 'Editá las URLs, nombres e IDs de los entregables generados.',
    pv_edit_deliverables_deck: 'Presentación (deck)',
    pv_edit_deliverables_checklist: 'Checklist',
    pv_edit_deliverables_package: 'Carpeta del paquete',
    pv_edit_lbl_file_url: 'URL del archivo',
    pv_edit_lbl_file_name: 'Nombre del archivo',
    pv_edit_lbl_file_id: 'ID en Drive',
    pv_edit_lbl_folder_url: 'URL de la carpeta',
    pv_edit_lbl_folder_name: 'Nombre de la carpeta',
    pv_lbl_client_name: 'Cliente',
    pv_lbl_proposal_name: 'Título de la propuesta',
    pv_reminders_heading: 'Fechas y recordatorios',
    pv_reminders_lead:
      'Programá recordatorios para enviar la propuesta y para revisarla antes del cierre. Podés exportarlos a Google Calendar o descargar un .ics.',
    pv_reminders_summary_none: 'Sin recordatorios agendados',
    pv_reminders_summary_one: '1 recordatorio agendado',
    pv_reminders_summary_many: '{count} recordatorios agendados',
    pv_reminder_send_title: 'Enviar propuesta',
    pv_reminder_send_lead: 'Recordatorio para la entrega al cliente (por defecto usa la fecha RFP).',
    pv_reminder_review_title: 'Revisar propuesta',
    pv_reminder_review_lead: 'Recordatorio interno para revisar el deck antes del envío.',
    pv_reminder_enable: 'Activar recordatorio',
    pv_reminder_datetime_label: 'Fecha y hora',
    pv_reminder_btn_gcal: 'Agregar a Google Calendar',
    pv_reminder_btn_ics: 'Descargar .ics',
    pv_reminder_btn_save: 'Guardar recordatorios',
    pv_reminder_saved: 'Recordatorios guardados.',
    pv_reminder_busy_save: 'Guardando recordatorios…',
    pv_reminder_err_datetime: 'Indicá una fecha y hora para el recordatorio.',
    pv_reminder_event_send: 'Enviar propuesta: {name}',
    pv_reminder_event_review: 'Revisar propuesta: {name}',
    err_proposal_session_update: 'No se pudo actualizar la propuesta.',
    pb_err_session_missing: 'Falta el identificador de la sesión de propuesta.',
    pb_err_session_not_found: 'No se encontró la propuesta solicitada.',
    pb_btn_open_material_drive: 'Abrir material en Drive',
    ...
    pb_studios_next_hint:
      'Revisá cada studio. Podés regenerar todas las lanes en paralelo o una por tipo. Después continuá a casos de éxito.',
    pb_btn_continue_configure: 'Continuar a configurar',
    pb_btn_continue_success_cases: 'Continuar a casos de éxito',
    pb_step_success_cases: 'Casos de éxito',
    pb_success_cases_heading: 'Casos de éxito sugeridos',
    pb_success_cases_lead:
      'Revisá al menos cinco referencias del catálogo y marcá cuáles incluir en la propuesta comercial.',
    pb_success_cases_next_hint:
      'Desmarcá los casos que no quieras en el deck. Podés continuar aunque no incluyas ninguno.',
    pb_success_cases_empty: 'No encontramos casos de éxito indexados para este brief.',
    pb_success_cases_summary_fmt: '{included} de {total} casos incluidos en la propuesta',
    pb_success_cases_include_label: 'Incluir en la propuesta',
    pb_success_cases_kg_match_prefix: 'Relacionado por:',
    pb_success_cases_filter_label: 'Filtrar por etiqueta KG:',
    pb_success_cases_filter_clear: 'Limpiar filtros',
    pb_success_cases_filter_no_match: 'Ningún caso coincide con los filtros seleccionados.',
    pb_success_case_score_tooltip: 'Score — lexical: {lexical} | semántico: {semantic} | grafo: {graph} | total: {similarity}',
    pb_busy_recommend_success_cases: 'Buscando casos de éxito y redactando justificaciones…',
    pb_err_success_cases: 'No se pudieron cargar los casos de éxito sugeridos.',
    pb_busy_save_success_cases: 'Guardando selección de casos de éxito…',
    pb_status_success_cases: 'Paso 4 de 6: elegí los casos de éxito para la propuesta.',
    pb_success_cases_phase_search: 'Buscando casos en el catálogo indexado',
    pb_success_cases_phase_match: 'Evaluando encaje con el brief',
    pb_success_cases_phase_agent: 'Redactando justificaciones con el agente',
    pb_success_cases_phase_finalize: 'Preparando la selección',
    pb_loader_success_cases_title: 'Preparando casos de éxito',
    pb_success_cases_step_label: 'Paso {current} de {total}',
    ...
    pb_validation_lead:
      'Revisá sección por sección lo que detectamos en tus materiales. Corregí lo necesario antes de armar el deck.',
    pb_brief_sec_client_heading: 'Cliente e identidad',
    pb_brief_sec_client_lead:
      'Compará lo extraído del material con el catálogo de Aviators y confirmá el nombre canónico del cliente.',
    pb_brief_sec_ask_heading: 'El pedido',
    pb_brief_sec_ask_lead:
      'Resumen ejecutivo, tecnologías detectadas y desglose de lo que el cliente está pidiendo.',
    pb_brief_subsec_scope_lead:
      'Cada ítem es un bloque del alcance. Agregá o quitá filas según el material analizado.',
    pb_brief_sec_commercial_heading: 'Condiciones comerciales',
    pb_brief_sec_commercial_lead:
      'Completá solo lo que el RFP mencione (modelo, plazos o presupuesto). Si no hay cifra ni tope, dejá el presupuesto vacío.',
    pb_brief_budget_group_label: 'Presupuesto',
    pb_brief_sec_people_heading: 'Personas y plazos',
    pb_brief_sec_people_lead:
      'Contactos e hitos solo si figuran en el material. No agregues personas ni fechas que no estén en el RFP.',
    pb_brief_subsec_stakeholders_lead:
      'Nombres y roles que aparezcan explícitamente en el documento. Si no hay contactos, no agregues filas.',
    pb_brief_subsec_milestones_lead:
      'Entregas, go-live u otros hitos con fecha aproximada si el documento los menciona.',
    pb_brief_sec_goals_heading: 'Objetivos y restricciones',
    pb_brief_sec_goals_lead:
      'Metas de negocio y límites operativos o contractuales que condicionan la solución.',
    pb_brief_empty_stakeholders: 'No se detectaron contactos en el material.',
    pb_brief_item_scope: 'Ítem {n}',
    pb_brief_item_milestone: 'Hito {n}',
    pb_brief_item_contact: 'Contacto {n}',
    pb_btn_remove_row: 'Quitar fila',
    ...
    pb_configure_heading: 'Configurar propuesta',
    pb_configure_lead:
      'Definí industria, idioma y qué secciones incluir en el deck antes de generarlo en Drive.',
    pb_configure_sec_industry_heading: 'Industria y plantilla',
    pb_configure_sec_industry_lead:
      'La industria determina el deck base y las slides de casos de éxito que se personalizan.',
    pb_configure_sec_language_heading: 'Idioma de redacción',
    pb_configure_sec_language_lead:
      'Define en qué idioma se redactará el deck y el contenido generado con IA.',
    pb_configure_sec_deck_heading: 'Secciones del deck',
    pb_configure_sec_deck_lead:
      'Elegí qué bloques institucionales incluir en la presentación final.',
    ...
    pb_busy_extracting_title: 'Extrayendo brief del material',
    pb_loader_extract_counter: 'Documento {current} de {total}',
    pb_loader_deck_counter: 'Etapa {current} de {total} del armado',
    pb_loader_notes_only: 'Analizando notas de contexto',
    pb_loader_hint_patience_1: 'El servidor sigue trabajando; esto puede tardar unos segundos.',
    pb_loader_hint_patience_2: 'Los PDFs extensos requieren más análisis con IA.',
    pb_loader_hint_patience_3: 'No cierres esta pestaña mientras procesamos el material.',
    pb_loader_hint_patience_4: 'Si tarda, es normal: estamos extrayendo cliente, alcance y fechas.',
    pb_extract_file_label: 'Archivo en curso: documento {current} de {total}',
    pb_extract_phase_prepare: 'Preparando lectura del archivo en el navegador…',
    pb_extract_phase_read_bytes: 'Codificando contenido para enviar al servidor…',
    pb_extract_phase_upload: 'Enviando documento al analizador de propuestas…',
    pb_extract_phase_analyze: 'Analizando texto, tablas e imágenes con IA…',
    pb_extract_phase_scope: 'Detectando alcance y pedidos del cliente…',
    pb_extract_phase_commercial: 'Extrayendo modelo comercial, presupuesto y plazos…',
    pb_extract_phase_contacts: 'Identificando stakeholders y contactos…',
    pb_extract_phase_client: 'Buscando coincidencia en el catálogo de clientes…',
    pb_extract_phase_finalize: 'Armando el brief para validación…',
    pb_extract_phase_fields: 'Extrayendo campos estructurados del brief…',
    pb_extract_phase_merge: 'Unificando información de todos los documentos…',
    pb_extract_merge_start: 'Iniciando unificación de briefs parciales…',
    pb_extract_merge_scope: 'Combinando ítems de alcance sin duplicar…',
    pb_extract_merge_commercial: 'Conciliando datos comerciales entre documentos…',
    pb_extract_merge_contacts: 'Fusionando contactos y stakeholders detectados…',
    pb_extract_merge_client: 'Resolviendo nombre de cliente y match de catálogo…',
    pb_extract_merge_finalize: 'Generando brief consolidado para el paso Brief…',
    pb_busy_resolving_deck: 'Preparando deck base…',
    pb_busy_creating_deck: 'Creando y personalizando presentación en Drive…',
    pb_busy_creating_deck_title: 'Creando propuesta en Drive',
    pb_create_step_label: 'Paso {current} de {total}',
    pb_step_compose_understanding: 'Redactando nuestro entendimiento',
    pb_step_copy_deck: 'Copiando plantilla en Drive',
    pb_step_compose_success_rationales: 'Casos de éxito y justificaciones',
    pb_step_customize_slides: 'Personalizando slides',
    pb_deck_sub_u_1: 'Revisando alcance y resumen del brief validado…',
    pb_deck_sub_u_2: 'Redactando «Nuestro entendimiento» con el agente de propuestas…',
    pb_deck_sub_u_3: 'Alineando mensaje con la industria y el idioma elegidos…',
    pb_deck_sub_u_4: 'Puliendo redacción comercial para las slides…',
    pb_deck_sub_c_1: 'Localizando plantilla base del deck en Drive…',
    pb_deck_sub_c_2: 'Copiando presentación a la carpeta Propuestas…',
    pb_deck_sub_c_3: 'Asignando nombre según cliente y alcance…',
    pb_deck_sub_c_4: 'Verificando permisos y acceso al archivo nuevo…',
    pb_deck_sub_r_1: 'Buscando casos de éxito relevantes en el catálogo…',
    pb_deck_sub_r_2: 'Generando por qué encaja cada caso con IA…',
    pb_deck_sub_r_3: 'Priorizando casos según industria del brief…',
    pb_deck_sub_r_4: 'Preparando textos para las slides de casos…',
    pb_deck_sub_s_1: 'Personalizando portada, agenda y secciones institucionales…',
    pb_deck_sub_s_2: 'Insertando entendimiento y alcance en las slides…',
    pb_deck_sub_s_3: 'Aplicando casos de éxito seleccionados…',
    pb_deck_sub_s_4: 'Guardando cambios finales en la presentación…',
    ...
    pb_err_extract_no_materials:
      'No se pudo leer ningún material para extraer el brief. Volvé a subir los archivos o usá «Analizar materiales» con archivos nuevos en esta sesión.',
    pb_err_extract_reupload_stored:
      'Los materiales guardados de sesiones anteriores no se re-analizan solos. Subí de nuevo los archivos que querés incluir en esta extracción.',
    pb_brief_sources_line: 'Fuentes analizadas en esta extracción: {files}',
    ...
    pb_status_studios: 'Paso 3 · Studios: revisá qué Globant Studios encajan con el brief.',
    pb_status_configure: 'Paso 5 · Configuración: industria, idioma y secciones del deck.',
    pb_status_building_progress: 'Paso 6 · Creando presentación en Drive…',
    pb_status_deck_ready: 'Paso 6 · Deck listo. Abrí la presentación en Drive.',
    ...
    pb_materials_dropzone_title: 'Arrastrá archivos o elegí desde tu equipo',
    pb_materials_dropzone_hint:
      'Podés subir varios a la vez (Ctrl/Cmd+clic o Shift) o sumar más después con «Agregar archivos».',
    pb_materials_dropzone_aria: 'Zona para soltar o elegir varios archivos de material',
    pb_materials_multi_badge: 'Selección múltiple',
    pb_materials_btn_pick_files: 'Elegir archivos',
    pb_materials_btn_add_more: 'Agregar archivos',
    pb_materials_list_heading: 'Archivos seleccionados',
    pb_materials_empty_list: 'Todavía no hay archivos. Subí RFP, anexos o notas para empezar.',
    pb_btn_remove_material: 'Quitar archivo',
    pb_btn_analyze_materials: 'Analizar materiales',
    pb_materials_count: '{count} archivo(s) listo(s) para analizar.',
    pb_materials_stored_notice:
      'Material de una sesión anterior (no se incluye al analizar). Subí de nuevo los archivos que quieras extraer.',
    pb_material_status_stored: 'Guardado',
    ...
    pb_story_client_empty_hint:
      'Completá el nombre del cliente manualmente si no apareció en el material.',
    pb_building_heading: 'Presentación en Drive',
    pb_building_lead:
      'La propuesta y el checklist de entregables quedaron en la carpeta del cliente en Drive. Revisá ambos archivos antes de enviar.',
    pb_building_ready_line:
      'Deck listo: {name} · Casos de éxito: {cases} · Ítems en checklist: {checklist}',
    pb_btn_open_proposal_folder: 'Abrir carpeta de la propuesta',
    pb_btn_open_deck: 'Abrir presentación',
    pb_btn_open_checklist: 'Abrir checklist de entregables',
    pb_checklist_file_name: 'Checklist entregables',
    pb_checklist_deck_file_name: 'Propuesta',
    pb_checklist_sheet_name: 'Entregables',
    pb_checklist_meta_client: 'Cliente: {client}',
    pb_checklist_meta_proposal: 'Propuesta: {proposal}',
    pb_checklist_col_item: 'Entregable',
    pb_checklist_col_due_date: 'Fecha límite',
    pb_checklist_col_status: 'Estado',
    pb_checklist_col_notes: 'Notas',
    pb_checklist_col_category: 'Categoría',
    pb_checklist_status_pending: 'Pendiente',
    pb_checklist_status_in_progress: 'En progreso',
    pb_checklist_status_done: 'Listo',
    pb_checklist_status_na: 'N/A',
    pb_checklist_cat_document: 'Documento',
    pb_checklist_cat_format: 'Formato',
    pb_checklist_cat_administrative: 'Administrativo',
    pb_checklist_cat_deadline: 'Plazo',
    pb_checklist_cat_content: 'Contenido',
    pb_checklist_cat_other: 'Otro',
    pb_checklist_item_deck: 'Presentación / deck de propuesta (Google Slides)',
    pb_checklist_item_rfp_deadline: 'Entregar propuesta antes de {date}',
    pb_checklist_item_commercial_model: 'Propuesta económica ({model})',
    pb_checklist_item_review_rfp_format: 'Revisar formato y canal de entrega exigidos en el RFP',
    pb_checklist_item_pricing: 'Incluir pricing / propuesta económica',
    pb_checklist_item_timeline: 'Incluir cronograma y plan de trabajo',
    pb_err_checklist_folder_missing: 'No se pudo resolver la carpeta de la propuesta en Drive.',
    pb_studios_heading: 'Studios recomendados',
    pb_studios_lead:
      'Según el brief validado, el agente de propuestas sugiere studios por relevancia en la oportunidad. El color indica el peso estimado (alta, media o baja).',
    pb_studios_priority_high_heading: 'Alta relevancia en la propuesta',
    pb_studios_priority_medium_heading: 'Relevancia media',
    pb_studios_priority_low_heading: 'Relevancia complementaria',
    pb_studio_priority_high: 'Alta',
    pb_studio_priority_medium: 'Media',
    pb_studio_priority_low: 'Baja',
    pb_studios_type_digital: 'Studios digitales',
    pb_studios_type_ai: 'Studios AI (industria)',
    pb_studios_type_enterprise: 'Studios Enterprise',
    pb_busy_recommend_studios: 'Consultando studios con el agente de propuestas…',
    pb_loader_studios_title: 'Recomendando Globant Studios',
    pb_loader_studios_subtitle:
      'Cuatro consultas en paralelo al agente Propuestas (AI-PODs, digitales, AI vertical y Enterprise) y fusión con el catálogo Aviators.',
    pb_studios_lanes_progress_fmt: '{done} de {total} pasos completados',
    pb_studios_lane_ai_pods_title: 'Playbook AI-PODs',
    pb_studios_lane_ai_pods_detail: 'Pitch estructurado de preventa para Globant AI-PODs (offering AI_PODS).',
    pb_studios_lane_digital_title: 'Studios digitales',
    pb_studios_lane_digital_detail: 'Capacidades transversales (Engineering, Data, CloudOps, etc.) sin AI-PODs.',
    pb_studios_lane_ai_vertical_title: 'Studios AI verticales',
    pb_studios_lane_ai_vertical_detail: 'Studios de industria (Airlines, Retail, Finance, etc.).',
    pb_studios_lane_enterprise_title: 'Studios Enterprise',
    pb_studios_lane_enterprise_detail: 'Plataformas SAP, Salesforce, cloud y partners — solo si el brief lo justifica.',
    pb_studios_lane_merge_title: 'Fusionar y enriquecer',
    pb_studios_lane_merge_detail: 'Unimos las cuatro respuestas, aplicamos reglas y vinculamos PDFs del catálogo.',
    pb_btn_refresh_studios_all: 'Regenerar todos los studios',
    pb_btn_refresh_lane_ai_pods: 'Regenerar AI-PODs',
    pb_btn_refresh_lane_digital: 'Regenerar digitales',
    pb_btn_refresh_lane_ai_vertical: 'Regenerar AI vertical',
    pb_btn_refresh_lane_enterprise: 'Regenerar Enterprise',
    pb_studios_lane_refreshed: 'Lane de studios actualizada.',
    pb_err_studios_lane: 'No se pudo regenerar esa lane de studios.',
    pb_studios_pipeline_agent_badge: 'Agente {agent}',
    pb_studios_step_catalog: 'Catálogo Aviators',
    pb_studios_step_catalog_detail: 'Listando studios indexados en propuestas comerciales (sin IA).',
    pb_studios_step_prompt: 'Armar contexto del brief',
    pb_studios_step_prompt_detail: 'Taxonomía Globant Studios + brief validado + catálogo en el prompt.',
    pb_studios_step_agent_recommend: 'Recomendar studios',
    pb_studios_step_agent_recommend_detail:
      'Pedimos JSON con studios, prioridad y offerings según el alcance del RFP.',
    pb_studios_step_policy: 'Reglas de negocio',
    pb_studios_step_policy_detail:
      'Garantizamos AI-PODs, mínimo de studios digitales/AI y taxonomía oficial.',
    pb_studios_step_agent_pitch: 'Playbook AI-PODs',
    pb_studios_step_agent_pitch_detail:
      'Segunda consulta: razones de venta, ganchos de slide y técnicas para el vendedor.',
    pb_studios_step_enrich: 'Enriquecer resultados',
    pb_studios_step_enrich_detail: 'Vinculamos PDFs del catálogo y metadatos por studio.',
    pb_studios_step_label: 'Paso {current} de {total}',
    pb_studios_phase_taxonomy: 'Clasificando studios digitales, AI y enterprise…',
    pb_studios_phase_brief: 'Revisando alcance, tecnologías e industria del brief…',
    pb_studios_phase_agent: 'Consultando al agente de propuestas de Globant…',
    pb_studios_phase_catalog: 'Cruzando recomendaciones con el catálogo indexado…',
    pb_studios_phase_rank: 'Priorizando studios más relevantes para la oportunidad…',
    pb_studio_rationale_heading: 'Por qué encaja',
    pb_studio_rationale_show_detail: 'Ver detalle completo',
    pb_studio_rationale_collapsed_fallback: 'Hay una recomendación detallada para este studio.',
    pb_why_fit_score_label: 'Nivel de encaje con el brief',
    pb_why_fit_score_aria_fmt: 'Encaje estimado: {score} por ciento',
    pb_why_fit_key_points_heading: 'Puntos clave',
    pb_why_fit_comparisons_heading: 'Comparativa',
    pb_why_fit_brief_links_heading: 'Brief ↔ Studio',
    pb_why_fit_col_aspect: 'Aspecto',
    pb_why_fit_col_without: 'Sin este studio',
    pb_why_fit_col_with: 'Con este studio',
    pb_why_fit_col_brief_need: 'Necesidad del brief',
    pb_why_fit_col_studio_offer: 'Aporte del studio',
    pb_studio_offerings_heading: 'Offerings',
    pb_ai_pods_pitch_summary_heading: 'Resumen ejecutivo',
    pb_ai_pods_vs_col_traditional: 'Enfoque tradicional',
    pb_ai_pods_vs_col_aipods: 'AI-PODs',
    pb_ai_pods_vs_col_seller: 'Ángulo comercial',
    pb_ai_pods_technique_when: 'Cuándo usarlo',
    pb_studios_empty: 'No se generaron recomendaciones de studios.',
    pb_studio_taxonomy_fallback_rationale:
      'Sugerido por taxonomía Globant según industria, tecnologías o alcance del brief.',
    pb_studio_ai_pods_fallback_rationale:
      'Globant AI-PODs acelera entregas de IA con squads dedicados, ciclos cortos y valor medible alineado al alcance del proyecto.',
    pb_ai_pods_pitch_why_heading: '10 razones para AI-PODs en este deal',
    pb_ai_pods_pitch_why_more_fmt: 'Ver {count} razones más',
    pb_ai_pods_pitch_hooks_heading: 'Ganchos para slides',
    pb_ai_pods_pitch_vs_heading: 'Frente a metodologías tradicionales',
    pb_ai_pods_pitch_techniques_heading: 'Técnicas para el vendedor',
    pb_ai_pods_pitch_brief_anchor: 'Anclaje al brief',
    ...
    pb_stakeholder_email_only_fallback: 'Contacto RFP',
    ...
    pb_btn_open_studio_document: 'Ver documento',
    ...
    err_prompt_empty: 'Prompt template cannot be empty.',
    err_prompt_json_invalid: 'Prompt must mention JSON output.',
    err_prompt_not_found: 'Prompt not found.',
    err_prompt_param_missing: 'Missing required prompt parameter.',
    err_prompt_rag_markers: 'RAG prompt must include {context} and {question} markers.',
    err_prompt_routing_invalid: 'Routing prompt must mention JSON and the "agents" field.',
    err_prompt_too_long: 'Prompt exceeds the maximum allowed length.',
    prompt_agents_clients_desc: 'Template for agents · clients · system',
    prompt_agents_clients_label: 'Agents clients',
    prompt_agents_onboarding_desc: 'Template for agents · onboarding · system',
    prompt_agents_onboarding_label: 'Agents onboarding',
    prompt_agents_orchestrator_routing_desc: 'Template for agents · orchestrator · routing · system',
    prompt_agents_orchestrator_routing_label: 'Agents orchestrator routing',
    prompt_agents_proposals_desc: 'Template for agents · proposals · system',
    prompt_agents_proposals_label: 'Agents proposals',
    prompt_agents_success_cases_desc: 'Template for agents · success_cases · system',
    prompt_agents_success_cases_label: 'Agents success cases',
    prompt_catalog_busy_load: 'Loading prompts…',
    prompt_catalog_busy_reset: 'Restoring prompt…',
    prompt_catalog_busy_save: 'Saving prompt…',
    prompt_catalog_customized_badge: 'Customized',
    prompt_catalog_err_load: 'Could not load the prompt catalog.',
    prompt_catalog_err_reset: 'Could not restore the prompt.',
    prompt_catalog_err_save: 'Could not save the prompt.',
    prompt_catalog_heading: 'LLM prompt catalog',
    prompt_catalog_lead: 'Edit English prompt templates used in every LLM call. Changes apply immediately. Use Reset to restore the original factory version.',
    prompt_catalog_len_fmt: '{len} / {max} characters',
    prompt_catalog_nav_heading: 'Sections',
    prompt_catalog_no_params: 'No parameters — static template.',
    prompt_catalog_param_required: 'required',
    prompt_catalog_params_heading: 'Parameters',
    prompt_catalog_params_lead: 'The code replaces these placeholders at runtime.',
    prompt_catalog_pick_one: 'Select a prompt from the list.',
    prompt_catalog_reset_btn: 'Restore original',
    prompt_catalog_reset_confirm: 'Restore this prompt to the original factory version?',
    prompt_catalog_reset_ok: 'Prompt restored to original.',
    prompt_catalog_role_rag_search: 'RAG search',
    prompt_catalog_role_system: 'System',
    prompt_catalog_role_user: 'User',
    prompt_catalog_save_btn: 'Save prompt',
    prompt_catalog_saved_ok: 'Prompt saved.',
    prompt_catalog_template_heading: 'Template (English)',
    prompt_catalog_template_ph: 'Prompt template…',
    prompt_ce_proposal_commercial_desc: 'Template for content · proposal · commercial · user',
    prompt_ce_proposal_commercial_label: 'Ce proposal commercial',
    prompt_ce_proposal_common_desc: 'Template for content · proposal · common · user',
    prompt_ce_proposal_common_label: 'Ce proposal common',
    prompt_ce_proposal_scope_desc: 'Template for content · proposal · scope · user',
    prompt_ce_proposal_scope_label: 'Ce proposal scope',
    prompt_ce_sc_challenge_desc: 'Template for content · sc · challenge · user',
    prompt_ce_sc_challenge_label: 'Ce sc challenge',
    prompt_ce_sc_common_desc: 'Template for content · sc · common · user',
    prompt_ce_sc_common_label: 'Ce sc common',
    prompt_ce_sc_impact_desc: 'Template for content · sc · impact · user',
    prompt_ce_sc_impact_label: 'Ce sc impact',
    prompt_ce_sc_solution_desc: 'Template for content · sc · solution · user',
    prompt_ce_sc_solution_label: 'Ce sc solution',
    prompt_ce_single_pass_desc: 'Template for content · extract · single_pass · user',
    prompt_ce_single_pass_label: 'Ce single pass',
    prompt_ce_system_desc: 'Template for content · extract · system',
    prompt_ce_system_label: 'Ce system',
    prompt_ce_system_proposal_pass_desc: 'Template for content · extract · system · proposal_pass',
    prompt_ce_system_proposal_pass_label: 'Ce system proposal pass',
    prompt_ce_system_success_pass_desc: 'Template for content · extract · system · success_pass',
    prompt_ce_system_success_pass_label: 'Ce system success pass',
    prompt_ce_tags_block_desc: 'Template for content · extract · tags_block',
    prompt_ce_tags_block_label: 'Ce tags block',
    prompt_gemini_preamble_desc: 'Template for gemini · consult · preamble',
    prompt_gemini_preamble_label: 'Gemini preamble',
    prompt_kg_system_desc: 'Template for kg · extract · system',
    prompt_kg_system_label: 'Kg system',
    prompt_kg_user_desc: 'Template for kg · extract · user',
    prompt_kg_user_label: 'Kg user',
    prompt_orch_catalog_fallback_desc: 'Template for orch · catalog_fallback · system',
    prompt_orch_catalog_fallback_label: 'Orch catalog fallback',
    prompt_orch_catalog_only_desc: 'Template for orch · catalog_only · system',
    prompt_orch_catalog_only_label: 'Orch catalog only',
    prompt_orch_clients_roster_rules_desc: 'Template for orch · clients_roster · response_rules',
    prompt_orch_clients_roster_rules_label: 'Orch clients roster rules',
    prompt_orch_doc_context_rules_desc: 'Template for orch · doc_context · response_rules',
    prompt_orch_doc_context_rules_label: 'Orch doc context rules',
    prompt_orch_ephemeral_answer_suffix_desc: 'Template for orch · ephemeral · answer · user_suffix',
    prompt_orch_ephemeral_answer_suffix_label: 'Orch ephemeral answer suffix',
    prompt_orch_ephemeral_answer_sys_desc: 'Template for orch · ephemeral · answer · system',
    prompt_orch_ephemeral_answer_sys_label: 'Orch ephemeral answer sys',
    prompt_orch_ephemeral_classify_sys_desc: 'Template for orch · ephemeral · classify · system',
    prompt_orch_ephemeral_classify_sys_label: 'Orch ephemeral classify sys',
    prompt_orch_ephemeral_classify_user_desc: 'Template for orch · ephemeral · classify · user',
    prompt_orch_ephemeral_classify_user_label: 'Orch ephemeral classify user',
    prompt_orch_fragment_language_desc: 'Template for orch · fragment · language',
    prompt_orch_fragment_language_label: 'Orch fragment language',
    prompt_orch_fragment_length_desc: 'Template for orch · fragment · response_length',
    prompt_orch_fragment_length_label: 'Orch fragment length',
    prompt_orch_fragment_metrics_header_desc: 'Template for orch · fragment · metrics_header',
    prompt_orch_fragment_metrics_header_label: 'Orch fragment metrics header',
    prompt_orch_fragment_role_desc: 'Template for orch · fragment · role_restriction',
    prompt_orch_fragment_role_label: 'Orch fragment role',
    prompt_orch_rag_profile_desc: 'Template for orch · rag_profile · orchestrator',
    prompt_orch_rag_profile_label: 'Orch rag profile',
    prompt_orch_routing_user_desc: 'Template for orch · routing · user',
    prompt_orch_routing_user_label: 'Orch routing user',
    prompt_orch_self_answer_desc: 'Template for orch · self_answer · system',
    prompt_orch_self_answer_label: 'Orch self answer',
    prompt_param_agent_list: 'Dynamic list of available agents.',
    prompt_param_question: 'Current user question.',
    prompt_pb_ai_pods_pitch_desc: 'Template for pb · ai_pods_pitch · user',
    prompt_pb_ai_pods_pitch_label: 'Pb ai pods pitch',
    prompt_pb_chat_context_desc: 'Template for pb · chat_context · user',
    prompt_pb_chat_context_label: 'Pb chat context',
    prompt_pb_extract_brief_sys_desc: 'Template for pb · extract_brief · system',
    prompt_pb_extract_brief_sys_label: 'Pb extract brief sys',
    prompt_pb_extract_brief_user_desc: 'Template for pb · extract_brief · user',
    prompt_pb_extract_brief_user_label: 'Pb extract brief user',
    prompt_pb_merge_briefs_sys_desc: 'Template for pb · merge_briefs · system',
    prompt_pb_merge_briefs_sys_label: 'Pb merge briefs sys',
    prompt_pb_merge_briefs_user_desc: 'Template for pb · merge_briefs · user',
    prompt_pb_merge_briefs_user_label: 'Pb merge briefs user',
    prompt_pb_studio_ai_desc: 'Template for pb · studio_lane · ai_vertical · user',
    prompt_pb_studio_ai_label: 'Pb studio ai',
    prompt_pb_studio_digital_desc: 'Template for pb · studio_lane · digital · user',
    prompt_pb_studio_digital_label: 'Pb studio digital',
    prompt_pb_studio_enterprise_desc: 'Template for pb · studio_lane · enterprise · user',
    prompt_pb_studio_enterprise_label: 'Pb studio enterprise',
    prompt_pb_success_rationales_desc: 'Template for pb · success_rationales · user',
    prompt_pb_success_rationales_label: 'Pb success rationales',
    prompt_pb_understanding_sys_desc: 'Template for pb · understanding · system',
    prompt_pb_understanding_sys_label: 'Pb understanding sys',
    prompt_pb_understanding_user_desc: 'Template for pb · understanding · user',
    prompt_pb_understanding_user_label: 'Pb understanding user',
    prompt_rag_default_desc: 'Template for rag · default_search_prompt',
    prompt_rag_default_label: 'Rag default',
    prompt_section_agents: 'Agents',
    prompt_section_content_extraction: 'Content extraction',
    prompt_section_gemini: 'Gemini (legacy)',
    prompt_section_knowledge_graph: 'Knowledge graph',
    prompt_section_orchestrator: 'Orchestrator',
    prompt_section_proposal_building: 'Proposal building',
    prompt_section_rag: 'RAG defaults',
    prompt_section_tags: 'Tag taxonomy',
    prompt_tags_merge_sys_desc: 'Template for tags · merge · system',
    prompt_tags_merge_sys_label: 'Tags merge sys',
    prompt_tags_merge_user_desc: 'Template for tags · merge · user',
    prompt_tags_merge_user_label: 'Tags merge user',
    settings_tab_prompts: 'Catálogo de prompts',
    prompt_ce_tag_strategy_label: 'Ce Tag Strategy',
    prompt_chat_document_system_section_label: 'Chat Document System Section',
    prompt_chat_document_wrapper_label: 'Chat Document Wrapper',
    prompt_gemini_user_assembly_label: 'Gemini User Assembly',
    prompt_globant_assistant_query_label: 'Globant Assistant Query',
    prompt_globant_consult_history_label: 'Globant Consult History',
    prompt_globant_rag_constraints_label: 'Globant Rag Constraints',
    prompt_orch_catalog_fallback_docs_label: 'Orch Catalog Fallback Docs',
    prompt_orch_ephemeral_catalog_docs_label: 'Orch Ephemeral Catalog Docs',
    prompt_orch_ephemeral_catalog_empty_label: 'Orch Ephemeral Catalog Empty',
    prompt_orch_internal_note_label: 'Orch Internal Note',
    prompt_orch_rag_graph_block_label: 'Orch Rag Graph Block',
    prompt_orch_rag_length_reminder_label: 'Orch Rag Length Reminder',
    prompt_orch_user_history_full_label: 'Orch User History Full',
    prompt_orch_user_history_plain_label: 'Orch User History Plain',
    prompt_pb_attachment_content_label: 'Pb Attachment Content',
    prompt_pb_chat_history_block_label: 'Pb Chat History Block',
    prompt_pb_image_hint_label: 'Pb Image Hint',
    prompt_pb_multi_doc_label: 'Pb Multi Doc',
    prompt_pb_user_message_block_label: 'Pb User Message Block',
    prompt_rag_coerce_suffix_label: 'Rag Coerce Suffix',
    prompt_section_infrastructure: 'Infraestructura LLM',
    ...
    err_globant_document_invalid_pdf:
      'El PDF no es válido o está corrupto (falta la cabecera %PDF). Probá reexportarlo o subí otra copia.',
    err_globant_document_no_pages:
      'Globant no pudo leer páginas del PDF (Vertex: «The document has no pages»). Reexportá el archivo, reducí su tamaño (<50 MB) o probá sin compresión extraña; si persiste, avisá al admin.',
    ...
    role_perm_view_proposal_building: 'Ver propuestas',
    role_perm_view_proposal_building_desc:
      'Acceso a Mis propuestas, detalle de propuesta y Globant Offering (consulta y revisión).',
    role_perm_build_proposals: 'Armar propuestas',
    role_perm_build_proposals_desc:
      'Usar el flujo guiado de Armado de propuestas: materiales, brief, studios, configuración y generación del deck.',
    role_perm_save_proposals: 'Guardar propuestas',
    role_perm_save_proposals_desc:
      'Persistir cambios en Supabase: crear sesión, editar, subir materiales, actualizar entregables y eliminar propuestas.',
    ...
    err_proposal_building_forbidden: 'No tenés permiso para acceder a Propuestas.',
    err_proposal_building_build_forbidden: 'No tenés permiso para armar propuestas.',
    err_proposal_building_save_forbidden: 'No tenés permiso para guardar o modificar propuestas.',
    ...
    metrics_overview_lead:
      'Indicadores por área (home, onboarding, Globant Offering, armado de propuestas), catálogo y feedback en la ventana elegida.',
    metrics_total_questions: 'Preguntas',
    metrics_total_unanswered: 'No respondidas',
    metrics_answer_rate: 'Tasa de respuesta',
    metrics_unique_users: 'Usuarios activos',
    metrics_onboarding_questions: 'Preguntas onboarding',
    metrics_offering_questions: 'Preguntas Globant Offering',
    metrics_proposals_built: 'Propuestas armadas',
    metrics_feedback_satisfaction: 'Satisfacción (👍)',
    metrics_trend_section_heading: 'Actividad por sección',
    metrics_trend_section_lead:
      'Volumen diario de preguntas desglosado por chat home, onboarding, Globant Offering y armado de propuestas.',
    metrics_section_mix_heading: 'Distribución por sección',
    metrics_section_mix_lead:
      'Participación relativa de cada área de producto en el total de preguntas del período.',
    metrics_section_home: 'Chat home',
    metrics_section_onboarding: 'Onboarding',
    metrics_section_globant_offering: 'Globant Offering',
    metrics_section_proposal_building: 'Armado de propuestas',
    metrics_section_other: 'Otros',
    metrics_catalog_heading: 'Catálogo de contenidos',
    metrics_catalog_lead:
      'Totales actuales en Contenidos y nodos del grafo de conocimiento (no filtrados por ventana).',
    metrics_catalog_success: 'Success cases',
    metrics_catalog_proposals: 'Propuestas (catálogo)',
    metrics_catalog_onboarding: 'Onboarding (PDFs)',
    metrics_catalog_clients: 'Clientes',
    metrics_catalog_kg_nodes: 'Nodos KG',
    metrics_proposal_status_heading: 'Estado de propuestas armadas',
    metrics_proposal_status_lead:
      'Sesiones de armado creadas en el período, por estado de finalización.',
    metrics_proposal_status_completed: 'Completadas',
    metrics_proposal_status_in_progress: 'En curso',
    metrics_proposal_status_failed: 'Fallidas',
    metrics_feedback_heading: 'Feedback del chat',
    metrics_feedback_lead: 'Valoraciones útiles / no útiles registradas en el período.',
    ...
    metrics_lb_proposal_builders: 'Quién armó más propuestas',
  ...
  en: {
    ...
    page_my_proposals_title: 'My proposals',
    page_my_proposals_lead:
      'Every proposal you build is saved with the extracted brief, uploaded materials, and links to the deck and delivery checklist on Drive.',
    my_proposals_loading: 'Loading your proposals…',
    my_proposals_empty: 'You have no saved proposals yet. Start a new build to create the first one.',
    my_proposals_empty_filtered: 'No proposals match the selected filters.',
    my_proposals_filter_status_label: 'Status',
    my_proposals_filter_industry_label: 'Industry',
    my_proposals_filter_step_label: 'Building step',
    my_proposals_filter_deliverables_label: 'Deliverables',
    my_proposals_filter_deliverables_any: 'With deliverables',
    my_proposals_filter_deliverables_deck: 'With assembled deck',
    my_proposals_filter_deliverables_package: 'With package',
    my_proposals_filter_deliverables_none: 'No deliverables',
    my_proposals_filter_search_label: 'Search proposals',
    my_proposals_filter_search_ph: 'Client, title or summary…',
    my_proposals_filter_label: 'Status',
    my_proposals_filter_all: 'All',
    my_proposals_filter_status_aria: 'Filter proposals by status',
    my_proposals_filter_clear: 'Clear filter',
    my_proposals_btn_start: 'Build new proposal',
    my_proposals_btn_new: 'New proposal',
    my_proposals_btn_view: 'View proposal',
    my_proposals_busy_loading: 'Loading proposal…',
    my_proposals_err_load: 'Could not load the proposal.',
    my_proposals_btn_delete: 'Delete',
    my_proposals_confirm_delete:
      'Remove this proposal from the list? Files in Drive are not deleted automatically.',
    my_proposals_busy_deleting: 'Deleting proposal…',
    my_proposals_deleted: 'Proposal removed from the list.',
    my_proposals_err_delete: 'Could not delete the proposal.',
    my_proposals_sec_list_heading: 'Proposal history',
    my_proposals_sec_list_lead:
      'Each card summarizes the client, build status and direct links to the deck and checklist in Drive.',
    my_proposals_meta_deadline: 'RFP due: {date}',
    my_proposals_meta_updated: 'Updated: {date}',
    my_proposals_client_unknown: 'Unnamed client',
    my_proposals_untitled: 'Untitled proposal',
    my_proposals_err_list: 'Could not load the proposals list.',
    my_proposals_col_client: 'Client',
    my_proposals_col_proposal: 'Proposal',
    my_proposals_col_industry: 'Industry',
    my_proposals_col_status: 'Status',
    my_proposals_col_deadline: 'RFP due',
    my_proposals_col_updated: 'Updated',
    my_proposals_col_links: 'Links',
    my_proposals_col_actions: 'Actions',
    my_proposals_sort_label: 'Sort by',
    my_proposals_sort_columns_aria: 'Sort proposals by column',
    my_proposals_sort_dir_asc: 'Ascending',
    my_proposals_sort_dir_desc: 'Descending',
    my_proposals_sort_dir_toggle: 'Toggle sort direction',
    my_proposals_links_pending: 'No files yet',
    my_proposals_status_completed: 'Completed',
    my_proposals_status_failed: 'Failed',
    my_proposals_status_in_progress: 'In progress',
    my_proposals_status_step: 'In progress · {step}',
    my_proposals_step_materials: 'Materials',
    my_proposals_step_brief: 'Brief',
    my_proposals_step_studios: 'Studios',
    my_proposals_step_success_cases: 'Success cases',
    my_proposals_step_configure: 'Configure',
    my_proposals_step_building: 'Deck',
    page_proposal_view_title: 'Proposal detail',
    page_proposal_view_lead:
      'Browse the summary, brief, materials, studios and deliverables for this proposal in read-only mode.',
    pv_btn_back: 'Back to my proposals',
    pv_busy_loading: 'Loading proposal…',
    pv_err_load: 'Could not load the proposal.',
    pv_tab_summary: 'Summary and brief',
    pv_tab_overview: 'Overview',
    pv_tab_brief: 'Brief',
    pv_tab_materials: 'Materials',
    pv_tab_studios: 'Studios',
    pv_tab_deliverables: 'Deliverables',
    pv_tabbar_aria: 'Proposal sections',
    pv_summary_sec_heading: 'Summary and brief',
    pv_summary_sec_lead:
      'Proposal overview, quick links and the validated brief extracted from materials.',
    pv_overview_sec_heading: 'At a glance',
    pv_overview_sec_lead:
      'Build status, key metrics and quick links to files generated in Drive.',
    pv_brief_sec_heading: 'Validated brief',
    pv_brief_sec_lead:
      'Detail extracted and confirmed from client materials, organized by section.',
    pv_materials_sec_heading: 'Source materials',
    pv_materials_sec_lead:
      'Documents linked to this proposal. Upload new files or add links to existing Drive files.',
    pv_materials_add_heading: 'Add material',
    pv_materials_upload_lead: 'Upload PDF, Word, text or images to the session folder.',
    pv_materials_btn_pick: 'Choose files',
    pv_materials_drive_lead: 'Google Drive link',
    pv_materials_drive_ph: 'https://drive.google.com/file/d/…',
    pv_materials_btn_add_drive: 'Add link',
    pv_materials_busy_upload: 'Uploading material…',
    pv_materials_busy_drive: 'Linking Drive file…',
    pv_materials_added: 'Material added to the proposal.',
    pv_materials_err_upload: 'Could not add the material.',
    pv_materials_err_drive_empty: 'Paste a Google Drive file link or ID.',
    pv_materials_source_drive: 'Drive link',
    err_proposal_material_drive: 'Could not access the Drive file. Check the link and permissions.',
    err_proposal_material_invalid: 'Invalid or empty material.',
    pv_deliverables_hero_deck_title: 'Built proposal',
    pv_deliverables_hero_deck_lead: 'Presentation generated when this proposal was built.',
    pv_deliverables_hero_package_title: 'Deliverables package',
    pv_deliverables_hero_package_lead: 'Drive folder with deck, checklist and package files.',
    pv_deliverables_btn_open_deck: 'Open built proposal',
    pv_deliverables_btn_open_package: 'Open full package',
    pv_studios_priority_icon_high: 'High relevance',
    pv_studios_priority_icon_medium: 'Medium relevance',
    pv_studios_priority_icon_low: 'Complementary',
    pv_studios_sec_heading: 'Recommended studios',
    pv_studios_sec_lead: 'Studios suggested from the brief and industry, grouped by relevance.',
    pv_deliverables_sec_heading: 'Artifacts and deck',
    pv_deliverables_sec_lead:
      'Built presentation, checklist, package folder and content options applied.',
    pv_lbl_industry: 'Industry',
    pv_lbl_commercial_model: 'Commercial model',
    pv_lbl_rfp_deadline: 'RFP due',
    pv_lbl_updated: 'Last updated',
    pv_lbl_materials_count: 'Materials',
    pv_lbl_studios_count: 'Studios',
    pv_lbl_scope_items: 'Scope items',
    pv_lbl_progress_step: 'Build status',
    pv_lbl_constraints: 'Constraints',
    pv_lbl_technology: 'Technology',
    pv_lbl_deck_sections: 'Deck sections',
    pv_agenda_module_title: 'Agenda',
    pv_agenda_module_lead: 'Presentation order and optional deck sections.',
    pv_agenda_module_count_fmt: '{count} items',
    pv_agenda_modal_title: 'Deck agenda',
    pv_agenda_modal_lead:
      'Optional sections configured during building and the final presentation agenda order.',
    pv_agenda_list_heading: 'Agenda order',
    pv_agenda_list_lead: 'Items shown on the agenda slide of the built proposal.',
    pv_btn_close_agenda: 'Close',
    pv_lbl_success_cases: 'Success cases applied',
    pv_deck_section_included: 'Included',
    pv_deck_section_excluded: 'Omitted',
    pv_overview_summary_heading: 'Project summary',
    pv_quick_links_heading: 'Quick links',
    pv_materials_empty: 'No materials recorded for this proposal.',
    pv_studios_empty: 'No recommended studios yet.',
    pv_deliverables_empty: 'No deliverables generated yet.',
    pv_brief_empty: 'No validated brief for this proposal yet.',
    pv_btn_open_case: 'Open case',
    pv_btn_edit: 'Edit',
    pv_btn_save: 'Save',
    pv_btn_cancel: 'Cancel',
    pv_btn_remove_row: 'Remove row',
    pv_busy_saving: 'Saving changes…',
    pv_btn_refresh_studios_all: 'Regenerate all studios',
    pv_btn_refresh_ai_pods_pitch: 'Regenerate AI-PODs pitch',
    pv_busy_refresh_studios_all: 'Regenerating studios (4 parallel calls)…',
    pv_busy_refresh_studios_lane: 'Regenerating studio lane…',
    pv_studios_refreshed: 'Studios updated.',
    pv_studios_lane_refreshed: 'Studio lane updated.',
    pv_err_refresh_studios: 'Could not regenerate studios.',
    pv_err_refresh_studios_lane: 'Could not regenerate that studio lane.',
    pv_busy_refresh_ai_pods_pitch: 'Regenerating AI-PODs pitch with the proposals agent…',
    pv_ai_pods_pitch_refreshed: 'AI-PODs pitch updated.',
    pv_err_refresh_ai_pods_pitch: 'Could not regenerate the AI-PODs pitch.',
    pv_saved: 'Proposal updated.',
    pv_err_save: 'Could not save changes.',
    pv_edit_brief_hint: 'Edit brief fields directly in this view. Save to persist your changes.',
    pv_edit_mode_hint:
      'Edit mode: you can change status, builder step, brief, materials, studios, and deliverables. Save to persist or cancel to discard.',
    pv_edit_lbl_internal_title: 'Internal title',
    pv_edit_lbl_material_name: 'Material name',
    pv_edit_lbl_material_url: 'Drive URL',
    pv_edit_btn_add_material: 'Add material',
    pv_edit_lbl_studio_name: 'Studio',
    pv_edit_lbl_studio_priority: 'Priority',
    pv_edit_lbl_studio_catalog: 'Catalog title',
    pv_edit_lbl_studio_offerings: 'Offerings (comma-separated)',
    pv_edit_lbl_studio_rationale: 'Rationale',
    pv_edit_studio_pitch_preview_heading: 'Rich preview (AI-PODs)',
    pv_edit_studio_rationale_plain_hint: 'Plain text for manual edits (saved alongside structured JSON).',
    pv_edit_lbl_studio_url: 'Drive URL',
    pv_edit_btn_add_studio: 'Add studio',
    pv_edit_deliverables_hint: 'Edit URLs, names, and Drive IDs for generated deliverables.',
    pv_edit_deliverables_deck: 'Presentation (deck)',
    pv_edit_deliverables_checklist: 'Checklist',
    pv_edit_deliverables_package: 'Proposal package folder',
    pv_edit_lbl_file_url: 'File URL',
    pv_edit_lbl_file_name: 'File name',
    pv_edit_lbl_file_id: 'Drive ID',
    pv_edit_lbl_folder_url: 'Folder URL',
    pv_edit_lbl_folder_name: 'Folder name',
    pv_lbl_client_name: 'Client',
    pv_lbl_proposal_name: 'Proposal title',
    pv_reminders_heading: 'Dates and reminders',
    pv_reminders_lead:
      'Enable optional reminders to send or review the proposal. Save preferences and add each event to Google Calendar or download an .ics file.',
    pv_reminders_summary_none: 'No reminders scheduled',
    pv_reminders_summary_one: '1 reminder scheduled',
    pv_reminders_summary_many: '{count} reminders scheduled',
    pv_reminder_send_title: 'Send proposal',
    pv_reminder_send_lead: 'Reminder for client delivery (defaults to the RFP date).',
    pv_reminder_review_title: 'Review proposal',
    pv_reminder_review_lead: 'Internal reminder to review the deck before sending.',
    pv_reminder_enable: 'Enable reminder',
    pv_reminder_datetime_label: 'Date and time',
    pv_reminder_btn_gcal: 'Add to Google Calendar',
    pv_reminder_btn_ics: 'Download .ics',
    pv_reminder_btn_save: 'Save reminders',
    pv_reminder_saved: 'Reminders saved.',
    pv_reminder_busy_save: 'Saving reminders…',
    pv_reminder_err_datetime: 'Set a date and time for the reminder.',
    pv_reminder_event_send: 'Send proposal: {name}',
    pv_reminder_event_review: 'Review proposal: {name}',
    err_proposal_session_update: 'Could not update the proposal.',
    pb_err_session_missing: 'Proposal session id is missing.',
    pb_err_session_not_found: 'The requested proposal was not found.',
    pb_btn_open_material_drive: 'Open material in Drive',
    ...
    pb_studios_next_hint:
      'Review each studio. You can regenerate all lanes in parallel or one type at a time. Then continue to success cases.',
    pb_btn_continue_configure: 'Continue to configure',
    pb_btn_continue_success_cases: 'Continue to success cases',
    pb_step_success_cases: 'Success cases',
    pb_success_cases_heading: 'Suggested success cases',
    pb_success_cases_lead:
      'Review at least five catalog references and choose which ones to include in the commercial proposal.',
    pb_success_cases_next_hint:
      'Uncheck cases you do not want in the deck. You can continue even if none are included.',
    pb_success_cases_empty: 'No indexed success cases were found for this brief.',
    pb_success_cases_summary_fmt: '{included} of {total} cases included in the proposal',
    pb_success_cases_include_label: 'Include in proposal',
    pb_success_cases_kg_match_prefix: 'Related by:',
    pb_success_cases_filter_label: 'Filter by KG label:',
    pb_success_cases_filter_clear: 'Clear filters',
    pb_success_cases_filter_no_match: 'No cases match the selected filters.',
    pb_success_case_score_tooltip: 'Score — lexical: {lexical} | semantic: {semantic} | graph: {graph} | total: {similarity}',
    pb_busy_recommend_success_cases: 'Finding success cases and drafting rationales…',
    pb_err_success_cases: 'Could not load suggested success cases.',
    pb_busy_save_success_cases: 'Saving success case selection…',
    pb_status_success_cases: 'Step 4 of 6: choose success cases for the proposal.',
    pb_success_cases_phase_search: 'Searching cases in the indexed catalog',
    pb_success_cases_phase_match: 'Scoring fit with the brief',
    pb_success_cases_phase_agent: 'Drafting rationales with the agent',
    pb_success_cases_phase_finalize: 'Preparing the selection',
    pb_loader_success_cases_title: 'Preparing success cases',
    pb_success_cases_step_label: 'Step {current} of {total}',
    ...
    pb_validation_lead:
      'Review each section of what we detected in your materials. Fix anything needed before building the deck.',
    pb_brief_sec_client_heading: 'Client and identity',
    pb_brief_sec_client_lead:
      'Compare material extraction with the Aviators catalog and confirm the canonical client name.',
    pb_brief_sec_ask_heading: 'The ask',
    pb_brief_sec_ask_lead:
      'Executive summary, detected technologies, and breakdown of what the client is requesting.',
    pb_brief_subsec_scope_lead:
      'Each row is a scope block. Add or remove rows based on the analyzed material.',
    pb_brief_sec_commercial_heading: 'Commercial terms',
    pb_brief_sec_commercial_lead:
      'Fill in only what the RFP states (model, deadlines, or budget). If no amount or cap is mentioned, leave budget empty.',
    pb_brief_budget_group_label: 'Budget',
    pb_brief_sec_people_heading: 'People and timeline',
    pb_brief_sec_people_lead:
      'Contacts and milestones only if they appear in the material. Do not add people or dates not in the RFP.',
    pb_brief_subsec_stakeholders_lead:
      'Names and roles explicitly stated in the document. If there are no contacts, do not add rows.',
    pb_brief_subsec_milestones_lead:
      'Deliverables, go-live, or other milestones with approximate dates if the document mentions them.',
    pb_brief_sec_goals_heading: 'Goals and constraints',
    pb_brief_sec_goals_lead:
      'Business objectives and operational or contractual limits that shape the solution.',
    pb_brief_empty_stakeholders: 'No contacts were detected in the material.',
    pb_brief_item_scope: 'Item {n}',
    pb_brief_item_milestone: 'Milestone {n}',
    pb_brief_item_contact: 'Contact {n}',
    pb_btn_remove_row: 'Remove row',
    ...
    pb_configure_heading: 'Configure proposal',
    pb_configure_lead:
      'Set industry, language and which deck sections to include before generating it in Drive.',
    pb_configure_sec_industry_heading: 'Industry and template',
    pb_configure_sec_industry_lead:
      'Industry determines the base deck and success-case slides that get customized.',
    pb_configure_sec_language_heading: 'Writing language',
    pb_configure_sec_language_lead:
      'Defines the language for the deck and AI-generated content.',
    pb_configure_sec_deck_heading: 'Deck sections',
    pb_configure_sec_deck_lead:
      'Choose which institutional blocks to include in the final presentation.',
    ...
    pb_busy_extracting_title: 'Extracting brief from material',
    pb_loader_extract_counter: 'Document {current} of {total}',
    pb_loader_deck_counter: 'Stage {current} of {total} in the build',
    pb_loader_notes_only: 'Analyzing context notes',
    pb_loader_hint_patience_1: 'The server is still working; this may take a few seconds.',
    pb_loader_hint_patience_2: 'Large PDFs need more AI analysis time.',
    pb_loader_hint_patience_3: 'Do not close this tab while we process the material.',
    pb_loader_hint_patience_4: 'If it takes a while, that is normal: we are extracting client, scope and dates.',
    pb_extract_file_label: 'Current file: document {current} of {total}',
    pb_extract_phase_prepare: 'Preparing file read in the browser…',
    pb_extract_phase_read_bytes: 'Encoding content to send to the server…',
    pb_extract_phase_upload: 'Sending document to the proposals analyzer…',
    pb_extract_phase_analyze: 'Analyzing text, tables and images with AI…',
    pb_extract_phase_scope: 'Detecting client ask and scope…',
    pb_extract_phase_commercial: 'Extracting commercial model, budget and deadlines…',
    pb_extract_phase_contacts: 'Identifying stakeholders and contacts…',
    pb_extract_phase_client: 'Matching client in the Aviators catalog…',
    pb_extract_phase_finalize: 'Building the brief for validation…',
    pb_extract_phase_fields: 'Extracting structured brief fields…',
    pb_extract_phase_merge: 'Merging information from all documents…',
    pb_extract_merge_start: 'Starting partial brief merge…',
    pb_extract_merge_scope: 'Combining scope items without duplicates…',
    pb_extract_merge_commercial: 'Reconciling commercial data across documents…',
    pb_extract_merge_contacts: 'Merging detected contacts and stakeholders…',
    pb_extract_merge_client: 'Resolving client name and catalog match…',
    pb_extract_merge_finalize: 'Generating consolidated brief for the Brief step…',
    pb_busy_resolving_deck: 'Preparing base deck…',
    pb_busy_creating_deck: 'Creating and customizing presentation in Drive…',
    pb_busy_creating_deck_title: 'Creating proposal in Drive',
    pb_create_step_label: 'Step {current} of {total}',
    pb_step_compose_understanding: 'Drafting our understanding',
    pb_step_copy_deck: 'Copying template to Drive',
    pb_step_compose_success_rationales: 'Success cases and rationales',
    pb_step_customize_slides: 'Customizing slides',
    pb_deck_sub_u_1: 'Reviewing scope and validated brief summary…',
    pb_deck_sub_u_2: 'Drafting «Our understanding» with the proposals agent…',
    pb_deck_sub_u_3: 'Aligning message with selected industry and language…',
    pb_deck_sub_u_4: 'Polishing commercial wording for slides…',
    pb_deck_sub_c_1: 'Locating base deck template in Drive…',
    pb_deck_sub_c_2: 'Copying presentation to the Proposals folder…',
    pb_deck_sub_c_3: 'Naming file from client and scope…',
    pb_deck_sub_c_4: 'Verifying permissions on the new file…',
    pb_deck_sub_r_1: 'Finding relevant success cases in the catalog…',
    pb_deck_sub_r_2: 'Generating why each case fits with AI…',
    pb_deck_sub_r_3: 'Prioritizing cases by brief industry…',
    pb_deck_sub_r_4: 'Preparing copy for success-case slides…',
    pb_deck_sub_s_1: 'Customizing cover, agenda and institutional sections…',
    pb_deck_sub_s_2: 'Inserting understanding and scope into slides…',
    pb_deck_sub_s_3: 'Applying selected success cases…',
    pb_deck_sub_s_4: 'Saving final changes to the presentation…',
    ...
    pb_err_extract_no_materials:
      'No material could be read to extract the brief. Re-upload files or run «Analyze materials» with new files in this session.',
    pb_err_extract_reupload_stored:
      'Materials saved from earlier sessions are not re-analyzed automatically. Upload again the files you want in this extraction.',
    pb_brief_sources_line: 'Sources analyzed in this extraction: {files}',
    ...
    pb_status_studios: 'Step 3 · Studios: review which Globant Studios fit the brief.',
    pb_status_configure: 'Step 5 · Configure: industry, language and deck sections.',
    pb_status_building_progress: 'Step 6 · Creating presentation in Drive…',
    pb_status_deck_ready: 'Step 6 · Deck ready. Open the presentation in Drive.',
    ...
    pb_materials_dropzone_title: 'Drop files here or pick from your device',
    pb_materials_dropzone_hint:
      'Upload several at once (Ctrl/Cmd+click or Shift) or add more later with «Add files».',
    pb_materials_dropzone_aria: 'Drop zone to pick multiple material files',
    pb_materials_multi_badge: 'Multiple selection',
    pb_materials_btn_pick_files: 'Choose files',
    pb_materials_btn_add_more: 'Add files',
    pb_materials_list_heading: 'Selected files',
    pb_materials_empty_list: 'No files yet. Upload an RFP, annexes, or notes to get started.',
    pb_btn_remove_material: 'Remove file',
    pb_btn_analyze_materials: 'Analyze materials',
    pb_materials_count: '{count} file(s) ready to analyze.',
    pb_materials_stored_notice:
      'Material from a previous session (not included when analyzing). Upload again the files you want to extract.',
    pb_material_status_stored: 'Saved',
    ...
    pb_story_client_empty_hint:
      'Enter the client name manually if it was not found in the material.',
    pb_building_heading: 'Presentation in Drive',
    pb_building_lead:
      'The proposal and delivery checklist are in the client folder on Drive. Review both files before submitting.',
    pb_building_ready_line:
      'Deck ready: {name} · Success cases: {cases} · Checklist items: {checklist}',
    pb_btn_open_proposal_folder: 'Open proposal folder',
    pb_btn_open_deck: 'Open presentation',
    pb_btn_open_checklist: 'Open delivery checklist',
    pb_checklist_file_name: 'Delivery checklist',
    pb_checklist_deck_file_name: 'Proposal',
    pb_checklist_sheet_name: 'Deliverables',
    pb_checklist_meta_client: 'Client: {client}',
    pb_checklist_meta_proposal: 'Proposal: {proposal}',
    pb_checklist_col_item: 'Deliverable',
    pb_checklist_col_due_date: 'Due date',
    pb_checklist_col_status: 'Status',
    pb_checklist_col_notes: 'Notes',
    pb_checklist_col_category: 'Category',
    pb_checklist_status_pending: 'Pending',
    pb_checklist_status_in_progress: 'In progress',
    pb_checklist_status_done: 'Done',
    pb_checklist_status_na: 'N/A',
    pb_checklist_cat_document: 'Document',
    pb_checklist_cat_format: 'Format',
    pb_checklist_cat_administrative: 'Administrative',
    pb_checklist_cat_deadline: 'Deadline',
    pb_checklist_cat_content: 'Content',
    pb_checklist_cat_other: 'Other',
    pb_checklist_item_deck: 'Proposal presentation / deck (Google Slides)',
    pb_checklist_item_rfp_deadline: 'Submit proposal before {date}',
    pb_checklist_item_commercial_model: 'Commercial proposal ({model})',
    pb_checklist_item_review_rfp_format: 'Review required submission format and channel in the RFP',
    pb_checklist_item_pricing: 'Include pricing / commercial proposal',
    pb_checklist_item_timeline: 'Include timeline and work plan',
    pb_err_checklist_folder_missing: 'Could not resolve the proposal folder on Drive.',
    pb_studios_heading: 'Recommended studios',
    pb_studios_lead:
      'Based on the validated brief, the proposals agent suggests studios by relevance to the opportunity. Color indicates estimated weight (high, medium or low).',
    pb_studios_priority_high_heading: 'High relevance to the proposal',
    pb_studios_priority_medium_heading: 'Medium relevance',
    pb_studios_priority_low_heading: 'Complementary relevance',
    pb_studio_priority_high: 'High',
    pb_studio_priority_medium: 'Medium',
    pb_studio_priority_low: 'Low',
    pb_studios_type_digital: 'Digital studios',
    pb_studios_type_ai: 'AI studios (industry)',
    pb_studios_type_enterprise: 'Enterprise studios',
    pb_busy_recommend_studios: 'Fetching studio recommendations from the proposals agent…',
    pb_loader_studios_title: 'Recommending Globant Studios',
    pb_loader_studios_subtitle:
      'Four parallel calls to the Proposals agent (AI-PODs, digital, AI vertical, and Enterprise) merged with the Aviators catalog.',
    pb_studios_lanes_progress_fmt: '{done} of {total} steps completed',
    pb_studios_lane_ai_pods_title: 'AI-PODs playbook',
    pb_studios_lane_ai_pods_detail: 'Structured pre-sales pitch for Globant AI-PODs (AI_PODS offering).',
    pb_studios_lane_digital_title: 'Digital studios',
    pb_studios_lane_digital_detail: 'Cross-cutting capabilities (Engineering, Data, CloudOps, etc.) excluding AI-PODs.',
    pb_studios_lane_ai_vertical_title: 'AI vertical studios',
    pb_studios_lane_ai_vertical_detail: 'Industry studios (Airlines, Retail, Finance, etc.).',
    pb_studios_lane_enterprise_title: 'Enterprise studios',
    pb_studios_lane_enterprise_detail: 'SAP, Salesforce, cloud platforms and partners — only when the brief supports it.',
    pb_studios_lane_merge_title: 'Merge and enrich',
    pb_studios_lane_merge_detail: 'Combine the four responses, apply rules, and link catalog PDFs.',
    pb_btn_refresh_studios_all: 'Regenerate all studios',
    pb_btn_refresh_lane_ai_pods: 'Regenerate AI-PODs',
    pb_btn_refresh_lane_digital: 'Regenerate digital',
    pb_btn_refresh_lane_ai_vertical: 'Regenerate AI vertical',
    pb_btn_refresh_lane_enterprise: 'Regenerate Enterprise',
    pb_studios_lane_refreshed: 'Studio lane updated.',
    pb_err_studios_lane: 'Could not regenerate that studio lane.',
    pb_studios_pipeline_agent_badge: 'Agent {agent}',
    pb_studios_step_catalog: 'Aviators catalog',
    pb_studios_step_catalog_detail: 'Listing studios indexed under commercial proposals (no AI).',
    pb_studios_step_prompt: 'Build brief context',
    pb_studios_step_prompt_detail: 'Globant Studios taxonomy + validated brief + catalog in the prompt.',
    pb_studios_step_agent_recommend: 'Recommend studios',
    pb_studios_step_agent_recommend_detail:
      'We request JSON with studios, priority and offerings based on RFP scope.',
    pb_studios_step_policy: 'Business rules',
    pb_studios_step_policy_detail:
      'We enforce AI-PODs, minimum digital/AI studios and official taxonomy.',
    pb_studios_step_agent_pitch: 'AI-PODs playbook',
    pb_studios_step_agent_pitch_detail:
      'Second call: sales reasons, slide hooks and techniques for the seller.',
    pb_studios_step_enrich: 'Enrich results',
    pb_studios_step_enrich_detail: 'We link catalog PDFs and metadata per studio.',
    pb_studios_step_label: 'Step {current} of {total}',
    pb_studios_phase_taxonomy: 'Classifying digital, AI and enterprise studios…',
    pb_studios_phase_brief: 'Reviewing scope, technologies and industry from the brief…',
    pb_studios_phase_agent: 'Querying the Globant proposals agent…',
    pb_studios_phase_catalog: 'Cross-checking recommendations with the indexed catalog…',
    pb_studios_phase_rank: 'Prioritizing the most relevant studios for the opportunity…',
    pb_studio_rationale_heading: 'Why it fits',
    pb_studio_rationale_show_detail: 'View full detail',
    pb_studio_rationale_collapsed_fallback: 'A detailed recommendation is available for this studio.',
    pb_why_fit_score_label: 'Brief fit level',
    pb_why_fit_score_aria_fmt: 'Estimated fit: {score} percent',
    pb_why_fit_key_points_heading: 'Key points',
    pb_why_fit_comparisons_heading: 'Comparison',
    pb_why_fit_brief_links_heading: 'Brief ↔ Studio',
    pb_why_fit_col_aspect: 'Aspect',
    pb_why_fit_col_without: 'Without this studio',
    pb_why_fit_col_with: 'With this studio',
    pb_why_fit_col_brief_need: 'Brief need',
    pb_why_fit_col_studio_offer: 'Studio offering',
    pb_studio_offerings_heading: 'Offerings',
    pb_ai_pods_pitch_summary_heading: 'Executive summary',
    pb_ai_pods_vs_col_traditional: 'Traditional approach',
    pb_ai_pods_vs_col_aipods: 'AI-PODs',
    pb_ai_pods_vs_col_seller: 'Seller angle',
    pb_ai_pods_technique_when: 'When to use',
    pb_studios_empty: 'No studio recommendations were generated.',
    pb_studio_taxonomy_fallback_rationale:
      'Suggested from Globant taxonomy based on industry, technologies or scope in the brief.',
    pb_studio_ai_pods_fallback_rationale:
      'Globant AI-PODs accelerates AI delivery with dedicated squads, short cycles and measurable value aligned to project scope.',
    pb_ai_pods_pitch_why_heading: '10 reasons for AI-PODs on this deal',
    pb_ai_pods_pitch_why_more_fmt: 'Show {count} more reasons',
    pb_ai_pods_pitch_hooks_heading: 'Slide hooks',
    pb_ai_pods_pitch_vs_heading: 'Vs. traditional methodologies',
    pb_ai_pods_pitch_techniques_heading: 'Techniques for the seller',
    pb_ai_pods_pitch_brief_anchor: 'Brief anchor',
    ...
    pb_stakeholder_email_only_fallback: 'RFP contact',
    ...
    pb_btn_open_studio_document: 'View document',
    ...
    err_prompt_empty: 'La plantilla no puede estar vacía.',
    err_prompt_json_invalid: 'El prompt debe mencionar salida JSON.',
    err_prompt_not_found: 'Prompt no encontrado.',
    err_prompt_param_missing: 'Falta un parámetro obligatorio del prompt.',
    err_prompt_rag_markers: 'El prompt RAG debe incluir los marcadores {context} y {question}.',
    err_prompt_routing_invalid: 'El prompt de ruteo debe mencionar JSON y el campo "agents".',
    err_prompt_too_long: 'El prompt supera la longitud máxima permitida.',
    prompt_agents_clients_desc: 'Plantilla para agents · clients · system',
    prompt_agents_clients_label: 'Agents clients',
    prompt_agents_onboarding_desc: 'Plantilla para agents · onboarding · system',
    prompt_agents_onboarding_label: 'Agents onboarding',
    prompt_agents_orchestrator_routing_desc: 'Plantilla para agents · orchestrator · routing · system',
    prompt_agents_orchestrator_routing_label: 'Agents orchestrator routing',
    prompt_agents_proposals_desc: 'Plantilla para agents · proposals · system',
    prompt_agents_proposals_label: 'Agents proposals',
    prompt_agents_success_cases_desc: 'Plantilla para agents · success_cases · system',
    prompt_agents_success_cases_label: 'Agents success cases',
    prompt_catalog_busy_load: 'Cargando prompts…',
    prompt_catalog_busy_reset: 'Restaurando prompt…',
    prompt_catalog_busy_save: 'Guardando prompt…',
    prompt_catalog_customized_badge: 'Personalizado',
    prompt_catalog_err_load: 'No se pudo cargar el catálogo de prompts.',
    prompt_catalog_err_reset: 'No se pudo restaurar el prompt.',
    prompt_catalog_err_save: 'No se pudo guardar el prompt.',
    prompt_catalog_heading: 'Catálogo de prompts LLM',
    prompt_catalog_lead: 'Editá plantillas de prompts en inglés usadas en cada llamada al LLM. Los cambios aplican de inmediato. Usá Restaurar para volver a la versión original de fábrica.',
    prompt_catalog_len_fmt: '{len} / {max} caracteres',
    prompt_catalog_nav_heading: 'Secciones',
    prompt_catalog_no_params: 'Sin parámetros — plantilla estática.',
    prompt_catalog_param_required: 'obligatorio',
    prompt_catalog_params_heading: 'Parámetros',
    prompt_catalog_params_lead: 'El código reemplaza estos marcadores en runtime.',
    prompt_catalog_pick_one: 'Elegí un prompt de la lista.',
    prompt_catalog_reset_btn: 'Restaurar original',
    prompt_catalog_reset_confirm: '¿Restaurar este prompt a la versión original de fábrica?',
    prompt_catalog_reset_ok: 'Prompt restaurado al original.',
    prompt_catalog_role_rag_search: 'Búsqueda RAG',
    prompt_catalog_role_system: 'Sistema',
    prompt_catalog_role_user: 'Usuario',
    prompt_catalog_save_btn: 'Guardar prompt',
    prompt_catalog_saved_ok: 'Prompt guardado.',
    prompt_catalog_template_heading: 'Plantilla (inglés)',
    prompt_catalog_template_ph: 'Plantilla del prompt…',
    prompt_ce_proposal_commercial_desc: 'Plantilla para content · proposal · commercial · user',
    prompt_ce_proposal_commercial_label: 'Ce proposal commercial',
    prompt_ce_proposal_common_desc: 'Plantilla para content · proposal · common · user',
    prompt_ce_proposal_common_label: 'Ce proposal common',
    prompt_ce_proposal_scope_desc: 'Plantilla para content · proposal · scope · user',
    prompt_ce_proposal_scope_label: 'Ce proposal scope',
    prompt_ce_sc_challenge_desc: 'Plantilla para content · sc · challenge · user',
    prompt_ce_sc_challenge_label: 'Ce sc challenge',
    prompt_ce_sc_common_desc: 'Plantilla para content · sc · common · user',
    prompt_ce_sc_common_label: 'Ce sc common',
    prompt_ce_sc_impact_desc: 'Plantilla para content · sc · impact · user',
    prompt_ce_sc_impact_label: 'Ce sc impact',
    prompt_ce_sc_solution_desc: 'Plantilla para content · sc · solution · user',
    prompt_ce_sc_solution_label: 'Ce sc solution',
    prompt_ce_single_pass_desc: 'Plantilla para content · extract · single_pass · user',
    prompt_ce_single_pass_label: 'Ce single pass',
    prompt_ce_system_desc: 'Plantilla para content · extract · system',
    prompt_ce_system_label: 'Ce system',
    prompt_ce_system_proposal_pass_desc: 'Plantilla para content · extract · system · proposal_pass',
    prompt_ce_system_proposal_pass_label: 'Ce system proposal pass',
    prompt_ce_system_success_pass_desc: 'Plantilla para content · extract · system · success_pass',
    prompt_ce_system_success_pass_label: 'Ce system success pass',
    prompt_ce_tags_block_desc: 'Plantilla para content · extract · tags_block',
    prompt_ce_tags_block_label: 'Ce tags block',
    prompt_gemini_preamble_desc: 'Plantilla para gemini · consult · preamble',
    prompt_gemini_preamble_label: 'Gemini preamble',
    prompt_kg_system_desc: 'Plantilla para kg · extract · system',
    prompt_kg_system_label: 'Kg system',
    prompt_kg_user_desc: 'Plantilla para kg · extract · user',
    prompt_kg_user_label: 'Kg user',
    prompt_orch_catalog_fallback_desc: 'Plantilla para orch · catalog_fallback · system',
    prompt_orch_catalog_fallback_label: 'Orch catalog fallback',
    prompt_orch_catalog_only_desc: 'Plantilla para orch · catalog_only · system',
    prompt_orch_catalog_only_label: 'Orch catalog only',
    prompt_orch_clients_roster_rules_desc: 'Plantilla para orch · clients_roster · response_rules',
    prompt_orch_clients_roster_rules_label: 'Orch clients roster rules',
    prompt_orch_doc_context_rules_desc: 'Plantilla para orch · doc_context · response_rules',
    prompt_orch_doc_context_rules_label: 'Orch doc context rules',
    prompt_orch_ephemeral_answer_suffix_desc: 'Plantilla para orch · ephemeral · answer · user_suffix',
    prompt_orch_ephemeral_answer_suffix_label: 'Orch ephemeral answer suffix',
    prompt_orch_ephemeral_answer_sys_desc: 'Plantilla para orch · ephemeral · answer · system',
    prompt_orch_ephemeral_answer_sys_label: 'Orch ephemeral answer sys',
    prompt_orch_ephemeral_classify_sys_desc: 'Plantilla para orch · ephemeral · classify · system',
    prompt_orch_ephemeral_classify_sys_label: 'Orch ephemeral classify sys',
    prompt_orch_ephemeral_classify_user_desc: 'Plantilla para orch · ephemeral · classify · user',
    prompt_orch_ephemeral_classify_user_label: 'Orch ephemeral classify user',
    prompt_orch_fragment_language_desc: 'Plantilla para orch · fragment · language',
    prompt_orch_fragment_language_label: 'Orch fragment language',
    prompt_orch_fragment_length_desc: 'Plantilla para orch · fragment · response_length',
    prompt_orch_fragment_length_label: 'Orch fragment length',
    prompt_orch_fragment_metrics_header_desc: 'Plantilla para orch · fragment · metrics_header',
    prompt_orch_fragment_metrics_header_label: 'Orch fragment metrics header',
    prompt_orch_fragment_role_desc: 'Plantilla para orch · fragment · role_restriction',
    prompt_orch_fragment_role_label: 'Orch fragment role',
    prompt_orch_rag_profile_desc: 'Plantilla para orch · rag_profile · orchestrator',
    prompt_orch_rag_profile_label: 'Orch rag profile',
    prompt_orch_routing_user_desc: 'Plantilla para orch · routing · user',
    prompt_orch_routing_user_label: 'Orch routing user',
    prompt_orch_self_answer_desc: 'Plantilla para orch · self_answer · system',
    prompt_orch_self_answer_label: 'Orch self answer',
    prompt_param_agent_list: 'Lista dinámica de agentes disponibles.',
    prompt_param_question: 'Pregunta actual del usuario.',
    prompt_pb_ai_pods_pitch_desc: 'Plantilla para pb · ai_pods_pitch · user',
    prompt_pb_ai_pods_pitch_label: 'Pb ai pods pitch',
    prompt_pb_chat_context_desc: 'Plantilla para pb · chat_context · user',
    prompt_pb_chat_context_label: 'Pb chat context',
    prompt_pb_extract_brief_sys_desc: 'Plantilla para pb · extract_brief · system',
    prompt_pb_extract_brief_sys_label: 'Pb extract brief sys',
    prompt_pb_extract_brief_user_desc: 'Plantilla para pb · extract_brief · user',
    prompt_pb_extract_brief_user_label: 'Pb extract brief user',
    prompt_pb_merge_briefs_sys_desc: 'Plantilla para pb · merge_briefs · system',
    prompt_pb_merge_briefs_sys_label: 'Pb merge briefs sys',
    prompt_pb_merge_briefs_user_desc: 'Plantilla para pb · merge_briefs · user',
    prompt_pb_merge_briefs_user_label: 'Pb merge briefs user',
    prompt_pb_studio_ai_desc: 'Plantilla para pb · studio_lane · ai_vertical · user',
    prompt_pb_studio_ai_label: 'Pb studio ai',
    prompt_pb_studio_digital_desc: 'Plantilla para pb · studio_lane · digital · user',
    prompt_pb_studio_digital_label: 'Pb studio digital',
    prompt_pb_studio_enterprise_desc: 'Plantilla para pb · studio_lane · enterprise · user',
    prompt_pb_studio_enterprise_label: 'Pb studio enterprise',
    prompt_pb_success_rationales_desc: 'Plantilla para pb · success_rationales · user',
    prompt_pb_success_rationales_label: 'Pb success rationales',
    prompt_pb_understanding_sys_desc: 'Plantilla para pb · understanding · system',
    prompt_pb_understanding_sys_label: 'Pb understanding sys',
    prompt_pb_understanding_user_desc: 'Plantilla para pb · understanding · user',
    prompt_pb_understanding_user_label: 'Pb understanding user',
    prompt_rag_default_desc: 'Plantilla para rag · default_search_prompt',
    prompt_rag_default_label: 'Rag default',
    prompt_section_agents: 'Agentes',
    prompt_section_content_extraction: 'Extracción de contenidos',
    prompt_section_gemini: 'Gemini (legacy)',
    prompt_section_knowledge_graph: 'Grafo de conocimiento',
    prompt_section_orchestrator: 'Orquestador',
    prompt_section_proposal_building: 'Armado de propuestas',
    prompt_section_rag: 'Defaults RAG',
    prompt_section_tags: 'Taxonomía de tags',
    prompt_tags_merge_sys_desc: 'Plantilla para tags · merge · system',
    prompt_tags_merge_sys_label: 'Tags merge sys',
    prompt_tags_merge_user_desc: 'Plantilla para tags · merge · user',
    prompt_tags_merge_user_label: 'Tags merge user',
    settings_tab_prompts: 'Prompts LLM',
    prompt_ce_tag_strategy_label: 'Ce Tag Strategy',
    prompt_chat_document_system_section_label: 'Chat Document System Section',
    prompt_chat_document_wrapper_label: 'Chat Document Wrapper',
    prompt_gemini_user_assembly_label: 'Gemini User Assembly',
    ...
    prompt_pb_user_message_block_label: 'Pb User Message Block',
    prompt_rag_coerce_suffix_label: 'Rag Coerce Suffix',
    prompt_section_infrastructure: 'LLM infrastructure',
    ...
    err_globant_document_invalid_pdf:
      'The PDF is invalid or corrupt (missing %PDF header). Try re-exporting it or upload another copy.',
    err_globant_document_no_pages:
      'Globant could not read PDF pages (Vertex: “The document has no pages”). Re-export the file, reduce size (<50 MB), or try without unusual compression; if it persists, contact an admin.',
    err_globant_assistant_not_found:
    ...
    role_perm_view_proposal_building: 'View proposals',
    role_perm_view_proposal_building_desc:
      'Access My proposals, proposal detail, and Globant Offering (review and consultation).',
    role_perm_build_proposals: 'Build proposals',
    role_perm_build_proposals_desc:
      'Use the guided Proposal building flow: materials, brief, studios, configuration, and deck generation.',
    role_perm_save_proposals: 'Save proposals',
    role_perm_save_proposals_desc:
      'Persist changes in Supabase: create sessions, edit, upload materials, update deliverables, and delete proposals.',
    ...
    err_proposal_building_forbidden: 'You do not have permission to access Proposals.',
    err_proposal_building_build_forbidden: 'You do not have permission to build proposals.',
    err_proposal_building_save_forbidden: 'You do not have permission to save or modify proposals.',
    ...
    metrics_overview_lead:
      'Indicators by area (home, onboarding, Globant Offering, proposal building), catalog, and feedback for the selected window.',
    metrics_total_questions: 'Questions',
    metrics_total_unanswered: 'Unanswered',
    metrics_answer_rate: 'Answer rate',
    metrics_unique_users: 'Active users',
    metrics_onboarding_questions: 'Onboarding questions',
    metrics_offering_questions: 'Globant Offering questions',
    metrics_proposals_built: 'Proposals built',
    metrics_feedback_satisfaction: 'Satisfaction (👍)',
    metrics_trend_section_heading: 'Activity by section',
    metrics_trend_section_lead:
      'Daily question volume split across home chat, onboarding, Globant Offering, and proposal building.',
    metrics_section_mix_heading: 'Section distribution',
    metrics_section_mix_lead:
      'Relative share of each product area in total questions for the period.',
    metrics_section_home: 'Home chat',
    metrics_section_onboarding: 'Onboarding',
    metrics_section_globant_offering: 'Globant Offering',
    metrics_section_proposal_building: 'Proposal building',
    metrics_section_other: 'Other',
    metrics_catalog_heading: 'Content catalog',
    metrics_catalog_lead:
      'Current totals in Contents and knowledge graph nodes (not filtered by window).',
    metrics_catalog_success: 'Success cases',
    metrics_catalog_proposals: 'Proposals (catalog)',
    metrics_catalog_onboarding: 'Onboarding (PDFs)',
    metrics_catalog_clients: 'Clients',
    metrics_catalog_kg_nodes: 'KG nodes',
    metrics_proposal_status_heading: 'Built proposal status',
    metrics_proposal_status_lead:
      'Proposal-building sessions created in the period, by completion status.',
    metrics_proposal_status_completed: 'Completed',
    metrics_proposal_status_in_progress: 'In progress',
    metrics_proposal_status_failed: 'Failed',
    metrics_feedback_heading: 'Chat feedback',
    metrics_feedback_lead: 'Helpful / not helpful ratings recorded in the period.',
    ...
    metrics_lb_proposal_builders: 'Top proposal builders',
