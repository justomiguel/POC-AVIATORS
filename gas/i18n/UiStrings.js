...
var UI_STRINGS = {
  es: {
    ...
    role_perm_view_catalog_desc: 'Navegar catálogo y cartera en modo lectura.',
    role_perm_write_catalog: 'Editar Contenidos y Clientes',
    role_perm_write_catalog_desc: 'Alta, edición, importación y borrado en catálogo y clientes.',
  ...
  en: {
    ...
    role_perm_view_catalog_desc: 'Browse catalog and portfolio in read-only mode.',
    role_perm_write_catalog: 'Edit Contents and Clients',
    role_perm_write_catalog_desc: 'Create, edit, import, and delete in catalog and clients.',
