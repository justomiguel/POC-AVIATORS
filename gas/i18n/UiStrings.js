...
var UI_STRINGS = {
  es: {
    ...
    page_knowledge_graph_lead:
      'Explorá cómo se relacionan contenidos, clientes, industrias y tags del catálogo. Usá los filtros para acotar el subgrafo y hacé clic en un nodo para ver detalle o abrir un contenido.',
    kg_filters_heading: 'Filtros',
    kg_filters_lead:
      'Acotá el grafo por tipo de contenido, industria o cliente. Si el catálogo es grande, el resultado puede estar truncado: afiná los filtros.',
    ...
    kg_empty: 'No hay nodos en el grafo. Subí contenidos o ejecutá «Reconstruir grafo».',
    kg_truncated: 'Vista truncada: {shown} nodos. Reducí profundidad o afiná filtros.',
    ...
    kg_edge_to: '→ {label}',
    kg_edge_from: '← {label}',
    kg_busy_vis: 'Cargando visualización…',
    err_kg_forbidden: 'No tenés permiso para ver el grafo de conocimiento.',
    kg_legend_heading: 'Leyenda',
    kg_legend_lead: 'Colores por tipo de nodo; las líneas indican el tipo de relación.',
  ...
  en: {
    ...
    page_knowledge_graph_lead:
      'Explore how catalog content, clients, industries, and tags connect. Use filters to focus the subgraph and click a node for details or to open a content item.',
    kg_filters_heading: 'Filters',
    kg_filters_lead:
      'Narrow the graph by content type, industry, or client. Large catalogs may return a truncated view—refine filters.',
    ...
    kg_empty: 'No nodes in the graph. Upload content or run «Rebuild graph».',
    kg_truncated: 'Truncated view: {shown} nodes. Lower depth or refine filters.',
